...
enum GameCatalog {
    ...
    static let library: [LibraryEntry] = [
        ...
        // Sky Postcards — a small collection unlocked along the familiar route.
        .init(id: "sky-postcard-first-flight", title: "A Postcard from the First Cloud", eyebrow: "Sky Postcard · First Flight", body: "The first cloud never asks for a perfect landing. It only asks you to arrive, look around, and notice that the field is a little smaller than it was a moment ago.", symbolName: "envelope.fill", tintHex: "F6C85F", unlockCondition: { $0.hasCompletedFirstFlight }),
        .init(id: "sky-postcard-feathers", title: "The Feather Forecast", eyebrow: "Sky Postcard · 10 Feathers", body: "A feather does not need to know its destination to travel well. Let the breeze make a tiny plan, then thank it with one calm turn toward the next cloud.", symbolName: "leaf.fill", tintHex: "E9A85D", unlockCondition: { $0.lifetimeFeathers >= 10 }),
        .init(id: "sky-postcard-return", title: "The Sky Remembers", eyebrow: "Sky Postcard · Three Flights", body: "By the third flight, the sky has begun to remember you: one friendly cloud, one familiar gust, and one new surprise waiting just beyond the barn.", symbolName: "arrow.counterclockwise.circle.fill", tintHex: "A895CB", unlockCondition: { $0.totalFlights >= 3 }),
        .init(id: "sky-postcard-flap", title: "A Note Written in the Air", eyebrow: "Sky Postcard · Rescue Flap", body: "A rescue flap is a small note written in the air: not today, not yet. It gives a brave little traveler enough room to choose the next kind landing.", symbolName: "hand.raised.fill", tintHex: "E98A72", unlockCondition: { $0.hasUsedFlap }),
        .init(id: "sky-postcard-fence", title: "The Fence Becomes a Pencil Line", eyebrow: "Sky Postcard · Height 25", body: "At this height, the fence becomes a pencil line and the clouds feel closer. Keep the view in your pocket; it will make the next flight feel brighter.", symbolName: "eye.fill", tintHex: "8FC9F1", unlockCondition: { $0.bestHeight >= 25 }),
        .init(id: "sky-postcard-spring", title: "A Spring Cloud Says Thank You", eyebrow: "Sky Postcard · Height 50", body: "A springy cloud always sounds a little pleased with itself. Meet it with steady feet and it may send a thank-you all the way into the open blue.", symbolName: "arrow.up.to.line.compact", tintHex: "A9C96E", unlockCondition: { $0.bestHeight >= 50 }),
        .init(id: "sky-postcard-airflow", title: "The Letter Inside the Wind", eyebrow: "Sky Postcard · Airflow", body: "When one airflow gathers three matching clouds, the sky feels like a letter with the answer already inside. Follow the rhythm, then add your own small flourish.", symbolName: "wind.circle.fill", tintHex: "73BED0", unlockCondition: { $0.hasSeenFlowHint }),
